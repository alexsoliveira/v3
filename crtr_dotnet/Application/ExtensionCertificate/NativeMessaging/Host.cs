...
namespace NativeMessaging
{
    ...
    public abstract class Host
    {
        ...
        private readonly string RegistroPath;
        ...
        public Host(bool sendConfirmationReceipt = true)
        {
            ...
            ManifestPath = Path.Combine(Utils.AssemblyLoadDirectory(), Hostname + ".json");

            RegistroPath = Path.Combine(Utils.AssemblyLoadDirectory(), ConfigurationManager.AppSettings["ProcessName"].ToString());
        ...
        {          
            ...
            else
            {
                ...
                string manifest = JsonConvert.SerializeObject(new Manifest(Hostname, description, RegistroPath, allowedOrigins));
